...
|-------------|-------------------------------------------------|----------------------------------------------------|-----|-----------|
| Infoscreen | <img src="https://github.com/kristianvaula/abakus-infoscreenclient/blob/main/screenshot.png" width="300"/>  | [Repo](https://github.com/kristianvaula/abakus-infoscreenclient) | (non-academic) | Volunteer work in Student Organization |
